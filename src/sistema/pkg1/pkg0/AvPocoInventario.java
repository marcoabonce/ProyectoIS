...
public class AvPocoInventario extends JFrame implements ActionListener{
    ...
    public AvPocoInventario(String mensaje1, String mensaje2, String idProv){
    ...
    private void AreadeTexto() {
        ...
        areaTexto.setText("        El producto "+this.mensaje1+" solo cuenta con ");
        areaTexto.append("\r\n");//añade más texto al area de texto
        areaTexto.append("               "+this.mensaje2+" unidades en almacen");//añade más texto al area de texto
        areaTexto.append("\r\n");//añade más texto al area de texto
