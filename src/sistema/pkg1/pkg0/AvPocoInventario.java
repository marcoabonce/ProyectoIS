...
public class AvPocoInventario extends JFrame{
    public JPanel panel, panel2;
    public AvPocoInventario(){
    ...
    private void AreadeTexto() {
        ...
        areaTexto.setText("        El producto XXXXX solo cuenta con ");
        areaTexto.append("\r\n");//añade más texto al area de texto
        areaTexto.append("               XX unidades en almacen");//añade más texto al area de texto
        areaTexto.append("\r\n");//añade más texto al area de texto
