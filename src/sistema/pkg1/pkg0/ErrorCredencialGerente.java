...
public class ErrorCredencialGerente extends JFrame{
    ...
    private void AreadeTexto() {
        ...
        areaTexto.setBounds(100 , 170, 300, 50);
        areaTexto.setText("       Su ID o Password son incorrectos.");
        areaTexto.append("\r\n");//añade más texto al area de texto
        areaTexto.append("                 Intente nuevamente");//añade más texto al area de texto
